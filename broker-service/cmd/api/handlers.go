...
func (app *Config) authenticate(w http.ResponseWriter, payload AuthPayload) {
	...
	body.Data = jsonFromService.Data

	app.writeJSON(w, http.StatusAccepted, body)
}
...
func (app *Config) logItemViaRPC(w http.ResponseWriter, l LogPayload) {
	...
	var result string
	// `RPCServer` is the type created on the server end
	// `LogInfo` is the function name 
